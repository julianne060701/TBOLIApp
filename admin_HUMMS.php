...
<div class="wrapper">
    ...
    <div class="table-title">
      <div class="row">
        <div class="col-sm-6 p-0 d-flex justify-content-lg-start justify-content-center">
          <h2 class="ml-lg-2">HUMMS Student</h2>
        </div>
      </div>
    </div>
    <?php
    ...
    $sqlCount = "SELECT COUNT(*) AS total FROM tbl_userinfo
              ...
              WHERE tbl_user_level.level = 'STUDENT' AND tbl_enrollment.program = 'HUMMS'";
    ...
    $sql = "SELECT tbl_userinfo.user_id, tbl_userinfo.firstname, tbl_userinfo.middlename, tbl_userinfo.lastname, tbl_userinfo.suffix, tbl_enrollment.userinfo_id, tbl_enrollment.admit_type, tbl_enrollment.grade, tbl_enrollment.program, tbl_enrollment.term, tbl_enrollment.lrn, tbl_enrollment.lsa, tbl_user_status.status, tbl_user_level.level
            ...
            WHERE tbl_user_level.level = 'STUDENT' AND tbl_enrollment.program = 'HUMMS' AND tbl_user_status.status = '1'
            LIMIT $limit OFFSET $offset";

    $result = mysqli_query($conn, $sql);
    ?>

<table class="table table-striped table-hover" id="humms_table">
  <thead>
    <tr>
      <th>ID</th>
      <th>Full Name</th>
...
var table = document.getElementById("humms_table");
